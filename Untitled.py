        ...
        if ret==True:
            ...
            if results.pose_landmarks :
              right_shoulder.append(
                  Point(results.pose_landmarks.landmarks[11].x,
                        results.pose_landmarks.landmarks[11].y,
                        1)
              )
              left_shoulder.append(
                  Point(results.pose_landmarks.landmarks[12].x,
                        results.pose_landmarks.landmarks[12].y,
                        2)
              )
